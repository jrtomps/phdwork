...
// This computes offsets for the 232Th target.
...
SetUpVectors(void)
{
  // Data for 232Th. These measurements are taken from the the
  // Inventor model FE_NewAssembly\Assembly_Concept_232Th
  // See the diagram in 238U_Inventor_measurement_diagram.odg
  vecs.push_back(Hep3Vector(-5.175*in, -0.682*in, 6.709*in)); // r0
  vecs.push_back(Hep3Vector(-5.954*in, -0.682*in, 7.489*in)); // r1
  vecs.push_back(Hep3Vector(-6.940*in,  0.713*in, 6.503*in)); // r2
  vecs.push_back(Hep3Vector(-6.161*in,  0.713*in, 5.723*in)); // r3
  vecs.push_back(Hep3Vector(-5.616*in, -0.612*in, 4.262*in)); // r4
  vecs.push_back(Hep3Vector(-7.398*in, -0.612*in, 4.262*in)); // r5
  vecs.push_back(Hep3Vector(-8.789*in, -2.008*in, 7.634*in)); // r6
  vecs.push_back(Hep3Vector(-4.226*in, -2.008*in, 7.634*in)); // r7
  vecs.push_back(Hep3Vector(-6.892*in, -0.698*in, 4.497*in)); // r8
  vecs.push_back(Hep3Vector(-5.568*in, -0.698*in, 4.497*in)); // r9

  vecs_c = vecs;
  
  // This is just about the center line of the silicon
...
ComputeTranslation()
{
  ...
  PrintHeader("Begin Translation Calc");
...
ComputeThickness(void)
{
  ...
  cout << "Points BEFORE rotation" << endl;
