...
#
set(ROOT_CXX_FLAGS " -pipe -m32 -msse -mfpmath=sse -fsigned-char -fPIC -pthread -std=c++11")
set(ROOT_C_FLAGS " -pipe -m32 -fPIC -pthread")
set(ROOT_fortran_FLAGS "")
set(ROOT_EXE_LINKER_FLAGS " ")
...
set(_root_options  asimage astiff builtin_afterimage builtin_ftgl builtin_glew builtin_llvm cxx11 cling exceptions explicitlink fortran genvector mathmore memstat opengl pch python qtgsi rpath shadowpw shared ssl thread tmva vdt xft xml x11)
...
#----------------------------------------------------------------------------
set(ROOT_DEFINITIONS  -pipe -m32 -msse -mfpmath=sse -Wshadow -Wall -W -Woverloaded-virtual -fsigned-char -fPIC -pthread -std=c++11 -Wno-deprecated-declarations)
