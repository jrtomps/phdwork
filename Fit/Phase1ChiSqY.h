#ifndef Phase1ChiSqY_H
#define Phase1ChiSqY_H
...
class Phase1ChiSqY : public ROOT::Math::IBaseFunctionMultiDim
{
...
public:
    //! Constructor
    /*!
      * Construct the Phase1ChiSqY with a TGraph2DErrors pointer,
      ...
      */
    Phase1ChiSqY(TGraph2DErrors* gr,
                const ROOT::Math::IParametricFunctionMultiDim& weighted_angdisty,
                const std::vector<TH2*>& solang_pdfs);

    //! Copy constructor
    Phase1ChiSqY(const Phase1ChiSqY& obj);

    //! Assignment operator
    /*! uses the copy-and-swap idiom */
    Phase1ChiSqY& operator=(Phase1ChiSqY obj);

    //! swap function to implement the copy-and-swap idiom
    friend void swap(Phase1ChiSqY& lhs, Phase1ChiSqY& rhs);

    //! Destructor
    virtual ~Phase1ChiSqY();
    ...
    virtual Phase1ChiSqY* Clone() const;
...
inline void swap(Phase1ChiSqY &lhs, Phase1ChiSqY &rhs)
{
