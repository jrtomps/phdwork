#ifndef Phase1ChiSq_H
#define Phase1ChiSq_H
...
class Phase1ChiSq : public ROOT::Math::IBaseFunctionMultiDim
{
...
public:
    //! Constructor
    /*!
      * Construct the Phase1ChiSq with a TGraph2DErrors pointer,
      ...
      */
    Phase1ChiSq(TGraph2DErrors* gr,
                const ROOT::Math::IParametricFunctionMultiDim& weighted_angdist,
                const std::vector<TH2*>& solang_pdfs);

    //! Copy constructor
    Phase1ChiSq(const Phase1ChiSq& obj);

    //! Assignment operator
    /*! uses the copy-and-swap idiom */
    Phase1ChiSq& operator=(Phase1ChiSq obj);

    //! swap function to implement the copy-and-swap idiom
    friend void swap(Phase1ChiSq& lhs, Phase1ChiSq& rhs);
    ...
    virtual Phase1ChiSq* Clone() const;
...
inline void swap(Phase1ChiSq &lhs, Phase1ChiSq &rhs)
{
