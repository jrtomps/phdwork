...
/*!
  ...
  */
class AngDistC : public ROOT::Math::IParametricFunctionMultiDim, public TFoamIntegrand
{
...
public:
    ...
    /*! The parameters are initialized to 1 and the range is set to be x[0] = [-1,1]
      ...
      */
    AngDistC(Double_t polarization=1.0,  POLARITY polarity=ELECTRIC);
    ...
    /*! The same initializations occur as in the default constructor but the
      ...
      * @param d is p[3]
      */
    AngDistC(Double_t a, Double_t b, Double_t c, Double_t d, Double_t polarization=1.0,  POLARITY polarity=ELECTRIC);
    ...
    /*!
      ...
      */
    AngDistC(const ::Parameters& params, Double_t polarization=1.0,  POLARITY polarity=ELECTRIC);
    //! Copy constructor
    AngDistC(const AngDistC& rhs);
    //! Assignment operator
    AngDistC& operator=(const AngDistC& rhs);

    virtual ~AngDistC();

    virtual AngDistC* Clone() const;
