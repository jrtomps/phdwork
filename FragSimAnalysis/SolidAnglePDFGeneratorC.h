...
#ifndef SolidAnglePDFGeneratorC_H
#define SolidAnglePDFGeneratorC_H 1

class TTree;
class TFile;
class TH2;

class SolidAnglePDFGeneratorC : public TSelectorInsert
{
public:
  SolidAnglePDFGeneratorC(TTree* tree, TFile *file, Double_t ethreshold=0);
  ~SolidAnglePDFGeneratorC();
...
private:
  ...
  ClassDef(SolidAnglePDFGeneratorC, 0);
};
