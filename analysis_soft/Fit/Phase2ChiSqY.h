#ifndef Phase2ChiSqY_H
#define Phase2ChiSqY_H
...
class Phase2ChiSqY : public ROOT::Math::IBaseFunctionMultiDim
{
public:
...
public:
    //! Constructor
    /*!
      * Construct the Phase2ChiSqY with a TGraph2DErrors pointer,
    ...
    //! Copy constructor
    Phase2ChiSqY(const Phase2ChiSqY& obj);

    //! Assignment operator
    /*! uses the copy-and-swap idiom */
    Phase2ChiSqY& operator=(Phase2ChiSqY obj);

    //! swap function to implement the copy-and-swap idiom
    friend void swap(Phase2ChiSqY& lhs, Phase2ChiSqY& rhs);

    //! Destructor
    virtual ~Phase2ChiSqY();
    ...
    virtual Phase2ChiSqY* Clone() const;
    ...
    /*! By default, the mapping is treated simply. It is assumed that the data set
      ...
      * remain as simple.
      */
    const std::map<UInt_t, Phase2ChiSqY::SSDPair >& GetPointToRegionMap() const;
...
inline void swap(Phase2ChiSqY &lhs, Phase2ChiSqY &rhs)
{
