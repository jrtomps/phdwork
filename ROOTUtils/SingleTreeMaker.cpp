...
////////// ////////// ////////// ////////// //////////
SingleTreeMaker::SingleTreeMaker(const TString absolutePath,
                                 const TString fileName,
                                 const Int_t compression,
                                 const TString treeName )
 : fClassName("SingleTreeMaker"),
 fMethodName(),
 fFileName(fileName),
 fPathAndName(absolutePath+"/"+fileName),
 fFile(0),
 fTreeName(treeName),
 ...
 fVarChar()
{
  ...
  CreateNewFileAndTree(absolutePath, fileName, compression, treeName);
...
////////// ////////// ////////// ////////// //p////////
void 
SingleTreeMaker::CreateNewFile(const TString path, const TString name, const Int_t compression )
{
...
////////// ////////// ////////// ////////// //////////
void 
SingleTreeMaker::CloseCurrentFile( void )
{
...
////////// ////////// ////////// ////////// //////////
void 
SingleTreeMaker::CreateNewTree(const TString name)
{
...
////////// ////////// ////////// ////////// //////////
void 
SingleTreeMaker::FillBranch(const TString varName, const TString varType, Int_t *val, const Int_t nEls)
{
...
////////// ////////// ////////// ////////// //////////
void 
SingleTreeMaker::CreateBranch(const TString varName, const TString varType, const Int_t nEls)
{
...
////////// ////////// ////////// ////////// //////////
void 
SingleTreeMaker::AutoSaveTree(void)
{
