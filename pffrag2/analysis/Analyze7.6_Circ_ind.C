...
void Analyze7p6_Circ_ind(bool force_recompile=true)
{
     ...
     if (myans=='n')
     {
         ...
         if (OkToContinue(message))
         {
             FormAlphaLTFCorrection(bgnd_id.Data(), // target label
                                   ...
                                   g4_sacorr_fname.Data(),//"", // this should make little difference but makes the alpha_ints_rate_sanormed hist
								   "alpha_ints_rate");         // sa_corr_fname
         }
