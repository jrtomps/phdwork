...
TString shift_data = "shifts_6.7_Lin_to_bgnd0.dat";
// includes runs
Double_t norm = 22303.4/20485.5; // (total 10Hz clock time prod. data)/(total 10Hz clock time bgnd)

void Analyze6p7_Lin(bool force_recompile=true)
{
...
//        FormAlphaCorrection(target.Data(), eg, pol.Data(), 678, "g4_sa_corr_232Th.dat");
    }
    ...
    if (OkToContinue(message))
    {
        ...
        {
            std::cout << "\tCalibrating adc with eg6.7_Lin_calib.dat"
                    << std::endl;
            CalibrateHists(dir, "eg6.7_Lin_calib.dat");
        }
        f->Close();
        dir = 0;
        ...
        {
            std::cout << "\tCalibrating ltf_corr_adc with eg6.7_Lin_calib.dat"
                    << std::endl;
            CalibrateHists(dir, "eg6.7_Lin_calib.dat");
        }
        ...
        {
            std::cout << "\tCalibrating ltf_corr_adc_gt_thresh with eg6.7_Lin_calib.dat"
                    << std::endl;
            CalibrateHists(dir, "eg6.7_Lin_calib.dat");
        }
...
//             FormAlphaCorrection(bgnd_id.Data(), 0, "--", 678, "g4_sa_corr_232Th.dat");
         }
...
//             std::cout << "\tNormalizing hists in ltf_corr_gt_thresh_sanormed directory" << std::endl;
//             dir = f->GetDirectory("ltf_corr_adc_gt_thresh_sanormed");
//             if (dir==0) std::cout << "Cannot find ltf_corr_adc_gt_thresh_sanormed folder" << std::endl;
//             else        NormalizeAllHists(dir,norm);
//             f->Close();
         }
         ...
         if (OkToContinue(message))
         {
             ...
             {
                 std::cout << "\tCalibrating adc with overnigh_bgnd0_calib.dat"
                         << std::endl;
                 CalibrateHists(dir, "overnight_bgnd0_calib.dat");
             }
             ...
             {
                 std::cout << "\tCalibrating normed_ltf_corr_adc with overnigh_bgnd0_calib.dat"
                         << std::endl;
                 CalibrateHists(dir, "overnight_bgnd0_calib.dat");
             }
             ...
             {
                 std::cout << "\tCalibrating normed_ltf_corr_adc_gt_thresh with overnight_bgnd0_calib.dat"
                         << std::endl;
                 CalibrateHists(dir, "overnight_bgnd0_calib.dat");
             }
...
//             else
//             {
//                 std::cout << "\tCalibrating normed_ltf_corr_adc_gt_thresh_sanormed with overnight_bgnd0_calib.dat"
//                         << std::endl;
//                 CalibrateHists(dir, "overnight_bgnd0_calib.dat");
//             }
         ...
         if (OkToContinue(message))
         {
             ...
             std::cout << "\tSubtracting ltf_corr_adc hists" << std::endl;
             TDirectory *dir = f->GetDirectory("ltf_corr_adc");
             if (dir==0)
             {
                 std::cout << "cannot find ltf_corr_adc histograms" << std::endl;
             }
             else
             {
             ...
             std::cout << "\tSubtracting ltf_corr_adc_gt_thresh hists" << std::endl;
             dir = f->GetDirectory("ltf_corr_adc_gt_thresh");
             if (dir==0)
             {
                 std::cout << "cannot find ltf_corr_adc_gt_thresh histograms" << std::endl;
             }
             else
             {
                 fbg = new TFile(overnight_hist_run.Data(),"UPDATE");
             ...
             std::cout << "\tSubtracting ltf_corr_adc_gt_thresh_tofcut hists" << std::endl;
             dir = f->GetDirectory("ltf_corr_adc_gt_thresh_tofcut");
             if (dir==0)
             {
                 std::cout << "cannot find ltf_corr_adc_gt_thresh_tofcut histograms" << std::endl;
             }
             else
             {
                 fbg = new TFile(overnight_hist_run.Data(),"UPDATE");
...
//
//             std::cout << "\tSubtracting ltf_corr_adc_gt_thresh_sanormed hists" << std::endl;
//             dir = f->GetDirectory("ltf_corr_adc_gt_thresh_sanormed");
//             if (dir==0)
//             {
//                 std::cout << "cannot find ltf_corr_adc_gt_thresh_sanormed histograms" << std::endl;
//             }
//             else
//             {
//                 fbg = new TFile(overnight_hist_run.Data(),"UPDATE");
//                 TDirectory *dirbg = fbg->GetDirectory("normed_ltf_corr_adc_gt_thresh_sanormed");
//                 if (dirbg==0) std::cout << "cannot find normed histograms in " << fbg->GetName() << std::endl;
//                 else          SubtractBgndRuns(dirbg,dir);
//                 fbg->Close();
//             }
     ...
     if (OkToContinue("compute systematic unc. from overnight bgnd histograms"))
     {
         ...
         TString corr_dir = "bgsubbed_ltf_corr_adc_gt_thresh";
         f = new TFile(combined_hist_run.Data(),"update");
...
//     }
    ...
    if (OkToContinue("integrate all \"adc_gt_thresh\" histograms"))
    {
        ...
        PAnalysis::IntegrateSiStrips(combined_hist_run,
                                     ...
                                     "",
                                     int_subbed_file,
                                     "bgsubbed_ltf_corr_adc_gt_thresh");
...
//                                     "bgsubbed_ltf_corr_adc_gt_thresh_sanormed");
    }
