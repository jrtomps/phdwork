...
//  gROOT->ProcessLine(".L analysis_soft/Scripts/UnnormalizeAllHists.C+");
  ...
  if (OkToContinue("combine 238U_232Th, Eg=5.9 MeV, Lin")) 
    {
      CombineAllRunsForTargetWithEnergyAndPol("238U_232Th",5.9,"Lin");
    }

  TFile *f, *fcorr;
  if (OkToContinue("Set errors on pffrag2_hist_run238U_232Th_5.9_Lin.root")) 
    {
      f = new TFile("pffrag2_hist_run238U_232Th_5.9_Lin.root","UPDATE");
    ...
    {
      PAnalysis::IntegrateSiStrips("pffrag2_hist_run238U_232Th_5.9_Lin.root",
				   "intbounds238U_232Th_5.9_Lin.dat",
				   "adc");				   
    }

    if (OkToContinue("generate angular distribution"))
    { 
      GenerateTGraphInputFiles("IntOutput/238U_232Th_5.9_Lin",
                              "angle_data/theta.dat",
                              "ang_dists/angdists238U_232Th_5.9_Lin.dat");
    }

    if (OkToContinue("apply circular corrections"))
      { 
	fcorr = new TFile("238U_232Th_7.6_Circ_corrections.root");
	f = new TFile("ang_dists/angdists238U_232Th_5.9_Lin.root","UPDATE");
