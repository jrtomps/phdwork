...
TString shift_data = "shifts_6.2_Lin_to_bgnd0.dat";
TString calib_file = "eg6.2_Lin_calib.dat";
TString bgnd_calib_file = "overnight_bgnd0_calib.dat";
TString g4_sacorr_fname = "g4_sa_corr_232Th.dat";

Double_t norm = 22834.5/20485.5; // (total 10Hz clock time prod. data)/(total 10Hz clock time bgnd)

void Analyze6p2_Lin_ind(bool force_recompile=true)
{
